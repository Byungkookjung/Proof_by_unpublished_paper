...
run_random_forest <- function(user_input, updated_data) {
  ...
  data <- read.csv("C:\\Users\\Aditya\\Dropbox\\PC\\Downloads\\Student Stress Factors.csv")
  colnames(data) <- c(
    "Sleep_Quality", 
    "Headaches_Per_Week",
...
original_data <- read.csv("C:\\Users\\Aditya\\Dropbox\\PC\\Downloads\\Student Stress Factors.csv")
...
# Example user input
user_data <- read.csv("C:\\Users\\Aditya\\Dropbox\\PC\\Downloads\\student_stress_dataset.csv")
